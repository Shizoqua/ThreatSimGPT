...
class CiiceroneMCPServer:
    """
    Main MCP server for Ciicerone VM operations.
    ...
    def __init__(
        ...
        logger.info(
            f"Ciicerone MCP Server initialized: "
    ...
    async def run(self):
        ...
        # Run server
        logger.info("Starting Ciicerone MCP Server on stdio...")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Ciicerone VM MCP Server"
    )
    parser.add_argument(
        "--config", "-c",
