...
async def generate_manual(request: ManualGenerationRequest):
    ...
    try:
        ...
        if request.use_rag:
            try:
                from ciicerone.rag.retriever import HybridRetriever
                from ciicerone.rag.config import RetrieverConfig
...
async def get_team_status(team: SecurityTeam):
    ...
    """
    try:
        from ciicerone.core.ai_enhanced_playbooks import ai_playbook_generator
        import json
