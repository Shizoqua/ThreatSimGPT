"""AI-Enhanced Playbook Generator for Ciicerone.
...
class AIEnhancedPlaybookGenerator:
    ...
    def __init__(self, llm_manager=None):
        ...
        Args:
            llm_manager: LLM manager instance for AI generation.
                        If None, will attempt to import from ciicerone.llm
        """
    ...
    def _get_llm_manager(self):
        ...
        if self.llm_manager is None:
            try:
                from ciicerone.llm import LLMProviderManager, LLMProviderConfig, LLMProvider, LLMModel
                import os
    ...
    async def generate_field_manual(
        ...
        # Generate with AI
        try:
            from ciicerone.llm import LLMRequest, LLMProvider, LLMModel, ContentType
...
|---------|------|--------|---------|
| 1.0 | {datetime.now().strftime('%Y-%m-%d')} | Ciicerone | Initial generation |

---

*This field manual was generated by Ciicerone using rule-based templates.*
...
> **Generated**: {datetime.now().isoformat()}
> **Generator**: Ciicerone AI-Enhanced Playbook System
...
| Version | Date | Author | Changes |
|---------|------|--------|---------|
| 2.0 | {datetime.now().strftime('%Y-%m-%d')} | Ciicerone AI | AI-enhanced generation |
| 1.0 | {datetime.now().strftime('%Y-%m-%d')} | Ciicerone | Initial template |
...
*This field manual was generated by Ciicerone's AI-Enhanced Playbook System.*
