"""Core data models for Ciicerone functionality.

This module provides the core data structures used throughout the Ciicerone system.
...
from .exceptions import CiiceroneError, SimulationError, ConfigurationError, ValidationError
